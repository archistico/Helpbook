    ...
    try {
        ...
        */
        ...
        foreach ($result as $row) {
            ...
            print "<td>";
            print "<a class='btn btn-xs btn-danger' href='stampacancella.php?fksoggetto=".$row['idstampa']."' role='button' style='width: 30px;margin-bottom: 3px'><i class = 'fa fa-remove'></i></a>";
            print "</td>";
            print "</tr>\n";
        }
        // chiude il database
