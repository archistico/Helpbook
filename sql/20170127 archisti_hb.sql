...
--
-- Host: localhost
-- Creato il: Gen 27, 2017 alle 17:52
...
INSERT INTO `movimenti` (`idmovimento`, `fktipologia`, `fkcausale`, `numero`, `anno`, `riferimento`, `fksoggetto`, `movimentodata`, `pagamentoentro`, `pagata`, `fkpagamentotipologia`, `datapagamento`, `spedizionecosto`, `spedizionesconto`, `fkaspetto`, `fktrasporto`, `fkmagazzino`, `note`, `chiuso`, `cancellato`) VALUES
(15, 1, 3, 1, 2016, '', 116, '2016-09-23', '2017-02-23', 0, 8, NULL, 0, 0, 1, 1, 118, '', 0, 0),
(16, 2, 1, 1, 2016, '', 116, '2016-09-23', '2016-09-23', 1, 6, '2016-09-23', 0, 0, 1, 1, 116, '', 0, 0),
(17, 2, 1, 2, 2016, '', 116, '2016-09-23', '2016-09-24', 1, 3, '2016-09-24', 1.28, 0, 2, 3, 118, '', 0, 0),
(18, 1, 6, 2, 2016, '', 116, '2016-09-24', '2016-09-23', 1, 9, NULL, 0, 0, 2, 1, 116, '', 0, 0),
(19, 5, 2, 1, 2016, 'Fiera susegana', 236, '2016-10-01', '2016-10-02', 0, 1, NULL, 1.28, 0, 1, 1, 236, '', 0, 0);
...
--
-- Dump dei dati per la tabella `stampe`
--

INSERT INTO `stampe` (`idstampa`, `fklibro`, `stampadata`, `stampaquantita`, `stampacosto`, `stampaspedizione`, `stampaiva`, `fktipografia`, `stampadocumento`, `cancellato`) VALUES
(7, 243, '2016-09-16', 100, 100, 200, 300, 9, '', 0),
(8, 243, '2016-01-01', 100, 100, 200, 300, 9, '', 0),
(9, 243, '2015-10-14', 100, 150, 250, 350, 9, '', 0),
(10, 14, '2016-09-21', 500, 1100, 20, 1300, 9, '', 0);
...
CREATE TABLE `utenti` (
  ...
  `fksoggetto` int(11) NOT NULL,
  `utenteruolo` varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT '-',
  `cancellato` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `utenti` (`idutente`, `utentenome`, `utentepw`, `fksoggetto`, `utenteruolo`, `cancellato`) VALUES
(1, 'emilie', 'e', 2, 'Amministratore', 0);
...
ALTER TABLE `utenti`
  ...
  ADD KEY `idutentetipologia` (`fksoggetto`);
...
--
ALTER TABLE `movimenti`
  MODIFY `idmovimento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
...
--
ALTER TABLE `movimentidettaglio`
  MODIFY `idmovimentodettaglio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
--
...
--
ALTER TABLE `stampe`
  MODIFY `idstampa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
