...
<head>
  ...
  <title> HelpBook | MOVIMENTI LISTA</title>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <form role="form" name="Form" action="movimentilistasoggettoSQL.php" method="get">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Cliente</label>
                    <select class="form-control select2" style="width: 100%;" name='idsoggetto' required>
                      <?php
