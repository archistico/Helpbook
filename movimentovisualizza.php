            ...
            <div class="content-wrapper">
                ...
                <section class="invoice">
                    ...
                    <?php
                        ...
                        $mov_pagato, $mov_pagamentotipologia, $mov_datapagamento, $mov_dataentro) = movimentoDettagli($idmovimento);
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>&euro;
                                            <?php echo number_format($mov_spedizione, 2). " (sconto ".number_format(($mov_spedizionesconto), 2)." %)" ?>
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="row no-print">
                        <div class="col-xs-12">
                            ...
                            <a target="_blank" href="movimentoPDF.php?idmovimento=<?php echo $_GET['idmovimento']?>" class="btn btn-primary pull-right" style="margin-right: 5px;">
                              <i class="fa fa-print"></i> CREA PDF
                            </a>

                            <a target="_blank" href="movimentoEMAILmit.php?idmovimento=<?php echo $_GET['idmovimento']?>" class="btn btn-primary pull-right" style="margin-right: 5px;">
                              <i class="fa fa-download"></i> INVIA EMAIL MITTENTE
                            </a>

                            <a target="_blank" href="movimentoEMAILdes.php?idmovimento=<?php echo $_GET['idmovimento']?>" class="btn btn-primary pull-right" style="margin-right: 5px;">
